(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var BASE_DURATION, TRESHOLD, isTransitioning, rows;
    rows = document.querySelectorAll('.row .row__body');
    TRESHOLD = -80;
    BASE_DURATION = 600;
    isTransitioning = false;
    return [].forEach.call(rows, function(row) {
      var POS_X, mc, onPanEnd, snapTo, transformX;
      mc = new Hammer(row, {});
      POS_X = 0;
